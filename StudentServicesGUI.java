        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    "INSERT INTO studentquery (StudentID, QueryType, QueryCategory, Details) VALUES (?,?,?,?)",
                    ...
                    if (rs.next()) {
                        int id = rs.getInt(1);
                        // Display the generated ID or use it as needed
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (queryID != null) {
                    try {
                        ...
                        PreparedStatement pstmt = con.prepareStatement(
                            "SELECT * FROM studentquery WHERE ID = ?");
                        ...
                        while (rs.next()) {
                            String[] row = { rs.getString("ID"), rs.getString("StudentID"),rs.getString("QueryType"), rs.getString("QueryCategory"), rs.getString("Details"),rs.getString("Status") };
                            rows.add(row);
                        }

                        // Create a table model with the query details and its associated responses
                        DefaultTableModel tableModel = new DefaultTableModel(rows.toArray(new Object[0][]), new String[] { "ID", "StudentID", "Query Type", "Query Category", "Details","Status" });
        ...
        viewAllButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	...
            	try {          
                    ...
                    ResultSet rs = stmt.executeQuery("select ID,StudentID,QueryType,QueryCategory,Details,Status from studentquery WHERE StudentID = '"+getid+"'");
